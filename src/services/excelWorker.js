...
/* La normalización de población vive en normalizacionPoblacion.js: la
   comparte con el script de precálculo del build, que debe producir
   exactamente el mismo resultado que este worker. */
