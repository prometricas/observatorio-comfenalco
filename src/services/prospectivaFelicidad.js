 ...
 * script de build) para que ambas vías produzcan el mismo resultado. El
 * generador determinista y la estadística auxiliar viven en
 * `simulacionDeterminista.js`, comunes con la simulación de Calidad de
 * vida digital.
 */
import {
  crearNormal,
